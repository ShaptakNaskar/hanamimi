...
class ListenEvent {
  ...
  /// normalize(title)|normalize(artist)|duration bucket — shared with
  /// the MinHash accumulator (utils/track_identity.dart).
  ...
  /// videoId / Saavn id at play time; null for local files.
  ...
  factory ListenEvent.fromRow(Map<String, Object?> r) => ListenEvent(
        ...
        source:
            TrackSource.values.byName(r['source'] as String? ?? 'local'),
