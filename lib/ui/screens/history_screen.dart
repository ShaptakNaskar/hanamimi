...
/// against the current library (path → identity), so history stays
/// browsable — and mostly playable — even after files move or vanish.
  ...
  Widget build(BuildContext context) {
    ...
    return Opacity(
      ...
      child: ListTile(
        ...
        trailing: Text(time, style: AppText.timestamp(theme)),
      ),
    );
  }
}
