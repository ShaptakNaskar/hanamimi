...
///
/// Purely local; nothing here touches the network. Seconds are derived
/// from the furthest playback position (same rule as play_tracker) so
/// pauses can't inflate a row and rewinds can't shrink one.
